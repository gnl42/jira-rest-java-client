...
public class WorklogJsonParserV5 implements JsonObjectParser<Worklog> {
    ...
    public Worklog parse(JSONObject json) throws JSONException {
        ...
        final OffsetDateTime creationDate = JsonParseUtil.parseDateTime(json, "created");
        final OffsetDateTime updateDate = JsonParseUtil.parseDateTime(json, "updated");
        final OffsetDateTime startDate = JsonParseUtil.parseDateTime(json, "started");
