...
public class ServerInfoJsonParser implements JsonObjectParser<ServerInfo> {
    ...
    public ServerInfo parse(JSONObject json) throws JSONException {
        ...
        final OffsetDateTime buildDate = JsonParseUtil.parseDateTime(json, "buildDate");
        final OffsetDateTime serverTime = JsonParseUtil.parseOptionalDateTime(json, "serverTime");
