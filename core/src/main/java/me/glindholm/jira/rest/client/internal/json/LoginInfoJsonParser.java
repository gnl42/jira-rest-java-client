...
public class LoginInfoJsonParser implements JsonObjectParser<LoginInfo> {
    ...
    public LoginInfo parse(JSONObject json) throws JSONException {
        ...
        final OffsetDateTime lastFailedLoginTime = JsonParseUtil.parseOptionalDateTime(json, "lastFailedLoginTime");
        final OffsetDateTime previousLoginTime = JsonParseUtil.parseOptionalDateTime(json, "previousLoginTime");
